    ...
    <div className="w-full space-y-10 pb-20 animate-in fade-in duration-1000 flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 px-4 shrink-0">
        <div>
            ...
            <h1 className="text-5xl md:text-6xl font-black italic tracking-tighter leading-[1.4] text-[#001A1A] py-2 px-1 overflow-visible">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#004d4d] via-[#00f2ff] to-[#004d4d] inline-block pb-4 pr-10">Mensajes Web</span>
            </h1>
