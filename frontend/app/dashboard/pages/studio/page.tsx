...
import { ChevronLeft, Save, Eye, Smartphone, Monitor, Tablet, MousePointer2, Loader2 } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col h-screen w-screen bg-gray-100 overflow-hidden text-gray-900 font-sans">
      ...
      <main className="flex-1 flex overflow-hidden relative">
        ...
        {/* EL INSPECTOR QUEDA FUERA DEL DNDCONTEXT PARA QUE SUS CONTROLES SEAN FLUIDOS */}
