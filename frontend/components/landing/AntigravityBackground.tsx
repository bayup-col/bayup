...
function Particles({ count = 150 }) {
  ...
  useFrame((state) => {
    particles.forEach((particle, i) => {
      ...
      particle.mx = THREE.MathUtils.lerp(particle.mx, mouseX, 0.05);
      particle.my = THREE.MathUtils.lerp(particle.my, mouseY, 0.05);
  ...
  return (
    <>
      <pointLight ref={light} distance={40} intensity={8} color="#00f2ff" />
