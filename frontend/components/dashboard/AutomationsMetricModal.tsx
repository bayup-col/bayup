...
interface AutomationsMetricModalProps {
  isOpen: boolean;
  onClose: () => void;
  metric: {
    label: string;
...
export default function AutomationsMetricModal({ isOpen, onClose, metric }: AutomationsMetricModalProps) {
            ...
            <div className="p-10 space-y-8">
                <section className="space-y-4">
                    <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-widest flex items-center gap-2">
                        <Activity size={14} className="text-[#004d4d]"/> Análisis de Eficiencia
                    </h4>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="p-6 bg-emerald-50/50 border border-emerald-100 rounded-3xl text-center">
                        <p className="text-[8px] font-black text-emerald-600 uppercase mb-1">Impacto Real</p>
                        <p className="text-xl font-black text-emerald-700">+12.5%</p>
                    </div>
