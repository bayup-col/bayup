                ...
                headers: [
                    {
                        ...
                        value: [
                            "default-src 'self'",
                            "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://framer.com https://*.framer.com https://*.framerusercontent.com https://checkout.wompi.co https://*.wompi.co https://cdn.tailwindcss.com",
